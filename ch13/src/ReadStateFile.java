...
public class ReadStateFile {
	public static void main(String[] args) {
		...
		fileName = "C:\\Users\\unite\\Desktop\\Douglas College\\2. 2021 Summer\\CSIS2175 Adv Integrated Software Dev (java)\\Week12\\"
				+ fileName;
		...
		try {
			...
			System.out.println("Total of all balance is $" + total);
			reader.close();
